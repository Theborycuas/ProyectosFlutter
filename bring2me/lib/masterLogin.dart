...
class SignInPageMaster extends StatefulWidget {
  final String title = 'Registration';
  @override
  State<StatefulWidget> createState() => SignInPageMasterState();
}

class SignInPageMasterState extends State<SignInPageMaster> {
  @override
