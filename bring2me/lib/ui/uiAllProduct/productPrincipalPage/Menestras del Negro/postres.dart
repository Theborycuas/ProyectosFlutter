...
class PostresMenestrasNegro extends StatelessWidget {
  final double height;
  final double width;
  final bool isLargeImg;

  const PostresMenestrasNegro(
            ...
            child: LayoutBuilder(
              builder: (BuildContext c, BoxConstraints constr) {
                return new StreamBuilder<QuerySnapshot>(
                  stream: Firestore.instance.collection('ciudad').document("ORYrQioVN7Pny0KZ6Mg7").collection('proveedor').document("H9hIw1pmrHdzBkt1Nujh").collection('categoria').document("GQ4XUhQt4DL5ZifegA70").collection('producto').snapshots(),      
