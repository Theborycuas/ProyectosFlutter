...
class HamburguesasKfc extends StatelessWidget {
  final double height;
  final double width;
  final bool isLargeImg;

  const HamburguesasKfc(
            ...
            child: LayoutBuilder(
              builder: (BuildContext c, BoxConstraints constr) {
                return new StreamBuilder<QuerySnapshot>(
                  stream: Firestore.instance.collection('ciudad').document("ORYrQioVN7Pny0KZ6Mg7").collection('proveedor').document("27xbICfN52yat7hdcokl").collection('categoria').document("MiN56Y40KwRMYytFGg08").collection('producto').snapshots(),      
