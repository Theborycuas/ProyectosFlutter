...
class ListCategoriaPrincipal extends StatefulWidget {
  const ListCategoriaPrincipal({Key key, @required this.user, this.usuDoc}):super(key:key);
  final FirebaseUser user;
  final DocumentSnapshot usuDoc;

  @override
  _ListCategoriaPrincipalState createState() => new _ListCategoriaPrincipalState();
}

var cardAspectRatio = 12.0 / 16.0;
var widgetAspectRatio = cardAspectRatio * 1.2;

class _ListCategoriaPrincipalState extends State<ListCategoriaPrincipal> {
